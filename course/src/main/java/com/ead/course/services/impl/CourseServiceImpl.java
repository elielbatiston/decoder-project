...
public class CourseServiceImpl implements CourseService {
    ...
    @Transactional
    @Override
    public void saveSubscriptionUserInCourseAndSendNotification(final CourseModel course, final UserModel user) {
        courseRepository.saveCourseUser(course.getCourseId(), user.getUserId());
        try {
            final var dto = new NotificationCommandDto();
            dto.setTitle("Bem-Vindo(a) ao curso: " + course.getName());
